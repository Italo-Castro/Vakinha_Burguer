...
import 'package:delivery_app/app/core/ui/widgtes/delivery_increment_decrement.dart';
...
class ProductDetailPage extends StatefulWidget {
  ...
  const ProductDetailPage(
      {Key? key, required this.product, required this.orderProductDto})
      : super(key: key);
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                ...
                Navigator.of(context).pop(
                  OrderProductDto(product: widget.product, amount: 0),
                );
              },
              child: Text(
                'Confirmar',
      ...
      body: Column(
        ...
        children: [
          Container(
            ...
            height: context.percemtHeight(.4),
